...
/**
 * Wortmarke „straightup digital" als Inline-SVG, gegenüber der Vorlage auf
 * `currentColor` umgestellt: sie färbt sich damit über die Textfarbe und
 * stimmt in beiden Farbschemata ohne eigene Regel.
 *
 * Die Farbe steht als ATTRIBUT `fill="currentColor"` an jedem der elf
 * Pfade. Der <style>-Block der Vorlage ist bewusst gestrichen: ein <style>
 * in Inline-SVG gilt dokumentweit, nicht SVG-lokal. Bei diesem Logo wäre
 * das harmlos gewesen (sein Selektor kam nur hier vor) — aber ein später
 * getauschtes Logo mit einem Selektor wie `text { … }` würde die ganze
 * Seite umfärben, und ein bloßer Zähler-Pin finge das nicht. Deshalb:
 * keine Stylesheet-Blöcke außer dem der Seite (per Test gepinnt:
 * </style>-Zähler 1). Das `stroke-width: 0px` der Vorlage entfällt
 * ersatzlos — kein Pfad trägt ein `stroke`, gezeichnet wird also ohnehin
 * keine Kontur. Skript-Anteile, Event-Attribute oder ein </script> enthält
 * das SVG nicht (ebenfalls gepinnt: </script>-Zähler 2, keine on…=).
 */
const LOGO_SVG = `<svg class="logo" role="img" aria-label="straightup digital" id="Ebene_2" data-name="Ebene 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 802.7 173.05">
  <g id="Ebene_1-2" data-name="Ebene 1">
    <g>
      <path fill="currentColor" d="m761.37,0c-22.77.06-41.18,18.57-41.12,41.34.06,22.77,18.57,41.18,41.34,41.12,22.77-.06,41.18-18.57,41.12-41.34C802.64,18.35,784.14-.06,761.37,0Zm.41,53.11l-19.25,9.67,19.18-48.21,19.36,48.14-19.29-9.6Z"/>
      <g>
        <path fill="currentColor" d="m0,81.8c0-10.39,9.64-20.03,26.7-20.03,13.36,0,23.74,4.45,23.74,4.45l-1.49,20.77h-5.19s-5.2-5.94-6.68-16.32c0,0-4.46-1.48-10.39-1.48-8.9,0-13.35,4.45-13.35,10.39,0,14.1,40.8,11.87,40.8,35.61,0,11.87-10.39,22.26-28.93,22.26-14.1,0-25.22-5.94-25.22-5.94l1.48-20.77h5.2s5.19,5.94,6.68,16.32c0,0,5.2,2.97,11.87,2.97,9.64,0,14.84-5.19,14.84-12.61,0-13.35-40.06-14.1-40.06-35.61Z"/>
        <path fill="currentColor" d="m63.81,71.41l-.75-4.45s5.2-4.46,13.36-5.94v-16.32h13.35v18.55h19.29v8.16h-19.29v49.71c0,4.45,2.97,7.42,7.42,7.42,6.68,0,14.1-5.19,14.1-5.19l2.97,5.19s-8.9,8.91-21.51,8.91c-9.65,0-16.32-6.68-16.32-16.32v-49.71h-12.61Z"/>
        <path fill="currentColor" d="m154.33,74.38l-6.68,8.16v44.51c6.68,1.48,11.13,4.45,11.13,4.45l-.75,4.45h-34.12l-.75-4.45s4.46-2.97,11.13-4.45v-53.42h-12.61l-.75-5.2s5.94-5.94,15.58-5.94c5.94,0,9.65,2.23,9.65,2.23v10.39h.74s6.68-13.36,19.29-13.36c5.2,0,8.91,2.23,8.91,2.23v10.39h-20.78Z"/>
        <path fill="currentColor" d="m416.25,81.8v45.25c5.94,1.48,8.91,4.45,8.91,4.45l-.75,4.45h-31.9l-.75-4.45s4.46-2.97,11.13-4.45V34.32h-12.61l-.75-5.2s5.94-5.94,17.07-5.94c5.93,0,9.64,2.23,9.64,2.23v39.32l-1.48,9.65h.74s9.65-12.61,24.48-12.61c13.35,0,22.26,8.9,22.26,23.74v41.54c6.68,1.48,11.13,4.45,11.13,4.45l-.74,4.45h-31.9l-.74-4.45s2.97-2.97,8.9-4.45v-41.54c0-9.65-5.19-14.84-13.35-14.84-11.13,0-19.29,11.13-19.29,11.13Z"/>
        <path fill="currentColor" d="m476.36,71.41l-.74-4.45s5.19-4.46,13.35-5.94v-16.32h13.36v18.55h19.29v8.16h-19.29v49.71c0,4.45,2.97,7.42,7.42,7.42,6.68,0,14.1-5.19,14.1-5.19l2.97,5.19s-8.9,8.91-21.51,8.91c-9.65,0-16.32-6.68-16.32-16.32v-49.71h-12.61Z"/>
        <path fill="currentColor" d="m618.81,125.57l.75,5.19s-5.94,5.94-15.58,5.94c-5.94,0-9.65-2.23-9.65-2.23v-9.64h-.74s-9.65,12.61-24.48,12.61c-13.35,0-22.26-8.91-22.26-23.74v-40.06h-12.61l-.74-5.2s5.94-5.94,17.06-5.94c5.94,0,9.65,2.23,9.65,2.23v48.97c0,9.65,5.19,14.84,13.35,14.84,11.13,0,19.29-11.13,19.29-11.13v-43.77h-12.62l-.74-5.2s5.94-5.94,17.06-5.94c5.94,0,9.65,2.23,9.65,2.23v60.84h12.61Z"/>
        <path fill="currentColor" d="m648.49,74.38s9.65-12.61,24.48-12.61c17.8,0,31.16,13.36,31.16,37.09s-15.58,38.58-34.13,38.58c-14.84,0-21.51-8.91-21.51-8.91h-.74l1.48,9.65v23.74c7.42,2.23,11.87,5.19,11.87,5.19l-.74,4.45h-34.87l-.75-4.45s4.46-2.97,11.13-5.19v-88.28h-12.61l-.75-5.2s5.94-5.94,15.58-5.94c5.94,0,9.65,2.23,9.65,2.23v9.65h.74Zm.74,34.87c0,12.61,7.42,20.03,19.29,20.03,11.13,0,20.77-9.65,20.77-29.68s-9.65-28.93-20.77-28.93-19.29,11.13-19.29,11.13v27.45Z"/>
      </g>
    </g>
  </g>
</svg>`;
 ...
 * Projekt-Arten) stehen NUR im JSON-Datenblock — dort wird "<" escaped, damit ein
 * "</script>" in einem Aufgabennamen ODER in einem Projekt-Art-Namen den
 * Block nicht beenden kann. Das Client-Skript baut alles mit
 * createElement/textContent auf; es gibt keinen Pfad, auf dem Daten als
 * HTML interpretiert werden.
 *
 * projekte trägt Art und Status der im Board vorkommenden Projekte für die
 * Filterleiste — dieselbe Form wie in der /board-Antwort, damit das
 * Nachladen den eingebetteten Stand eins zu eins ersetzen kann.
 */
export function renderSeite(
  stand: BoardStand,
  betrachter: Betrachter | null,
  projekte: ProjekteProId
): string {
  const daten = JSON.stringify({ ...stand, betrachter, projekte }).replace(/</g, "\\u003c");
  return `<!doctype html>
<html lang="de">
<meta charset="utf-8">
